...
Route::post('/events/join/{id}', [EventeController::class, 'joinEvent'])->middleware('auth');
Route::delete('/events/leave/{id}', [EventeController::class, 'leaveEvent'])->middleware('auth');
